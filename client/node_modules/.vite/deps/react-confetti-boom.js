...
function Confetti(props) {
  var _a = props.mode, mode = _a === void 0 ? "boom" : _a, _b = props.particleCount, particleCount = _b === void 0 ? 30 : _b, _c = props.shapeSize, shapeSize = _c === void 0 ? 12 : _c, _d = props.colors, colors = _d === void 0 ? ["#ff577f", "#ff884b", "#ffd384", "#fff9b0"] : _d, className = props.className, style = props.style;
  var _e = props.mode === "boom" || props.mode === void 0 ? props : {
    effectInterval: 1,
    effectCount: Infinity
  }, _f = _e.x, x = _f === void 0 ? 0.5 : _f, _g = _e.y, y = _g === void 0 ? 0.5 : _g, _h = _e.deg, deg = _h === void 0 ? 270 : _h, _j = _e.spreadDeg, spreadDeg = _j === void 0 ? 30 : _j, _k = _e.effectInterval, effectInterval = _k === void 0 ? 3e3 : _k, _l = _e.effectCount, effectCount = _l === void 0 ? 1 : _l, _m = _e.launchSpeed, launchSpeed = _m === void 0 ? 1 : _m, _o = _e.opacityDeltaMultiplier, opacityDeltaMultiplier = _o === void 0 ? 1 : _o;
  var _p = (props.mode === "fall" ? props : {}).fadeOutHeight, fadeOutHeight = _p === void 0 ? 0.8 : _p;
  ...
  var createConfetti = (0, import_react.useCallback)(function() {
    ...
    var effectiveOpacityDelta = isFallMode ? 3.4 / fadeOutHeight / window.innerHeight : 4e-3 * Math.max(0.1, opacityDeltaMultiplier);
